...
function getUpcomingBirthdays(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, sqlReq, sql, dbReq, dbResponse, notifs, response, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sqlReq = sql_request_1.SqlRequest.getUpcomingBirthdays();
                ...
                case 3:
                    dbResponse = _a.sent();
                    conn.end();
                    notifs = dbResponse[0].map(function (res) {
                        return new models_1.BirthdayNotification(res['wisherToken'], res['friendId'], res['message']);
                    });
                    response = {
                        'data': notifs,
                        'count': notifs.length,
