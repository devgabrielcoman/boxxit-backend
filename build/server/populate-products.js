...
function populateProducts(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, productResults, dbResult, response, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    return [4, get_product_data_1.getProductData(conn, null)];
                case 2:
                    productResults = _a.sent();
                    return [4, write_product_data_1.writeProductData(conn, productResults)];
                case 3:
                    dbResult = _a.sent();
                    conn.end();
                    response = {
